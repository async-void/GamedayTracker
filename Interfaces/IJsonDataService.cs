...
namespace GamedayTracker.Interfaces
{
    public interface IJsonDataService
    {
        ...
        Task<Result<GuildMember, SystemError<JsonDataServiceProvider>>> GetMemberFromJsonAsync(ulong memberId, ulong guildId);
        ...
        Task<Result<Guild, SystemError<JsonDataServiceProvider>>> GetMemberGuildFromJsonAsync(ulong memberId, ulong guildId);
        Task<Result<List<GuildMember>, SystemError<JsonDataServiceProvider>>> GetAllMembersForScope(int scope, ulong guildId);
        Task<Result<List<Guild>, SystemError<JsonDataServiceProvider>>> GetGuildsFromJsonAsync();
        Task<Result<Guild, SystemError<JsonDataServiceProvider>>> GetGuildFromJsonAsync(ulong guildId);
